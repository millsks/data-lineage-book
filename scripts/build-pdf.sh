...
CHAPTERS=(
  ...
  "$ROOT_DIR/chapters/07-kedro-lineage.md"
  "$ROOT_DIR/chapters/08-airflow-and-marquez.md"
  "$ROOT_DIR/chapters/09-spark-lineage.md"
  "$ROOT_DIR/chapters/10-dbt-lineage.md"
  "$ROOT_DIR/chapters/11-column-level-lineage.md"
  "$ROOT_DIR/chapters/12-graph-databases-lineage.md"
  "$ROOT_DIR/chapters/13-lineage-api-fastapi.md"
  "$ROOT_DIR/chapters/14-data-quality-lineage.md"
  "$ROOT_DIR/chapters/15-data-observability.md"
  "$ROOT_DIR/chapters/16-streaming-lineage.md"
  "$ROOT_DIR/chapters/17-compliance-governance-privacy.md"
  "$ROOT_DIR/chapters/18-data-mesh-federated-lineage.md"
  "$ROOT_DIR/chapters/19-ml-lineage.md"
  "$ROOT_DIR/chapters/20-genai-llm-lineage.md"
  "$ROOT_DIR/chapters/21-lineage-at-scale.md"
  "$ROOT_DIR/chapters/22-capstone-project.md"
)
