"""Chapter 12 Exercise — Lineage REST API with FastAPI.

Build a simple lineage API server using FastAPI.

Usage:
    # Run the server
    pixi run -e exercises uvicorn docs.exercises.ch12_lineage_api:app --reload --port 8001

    # Run the client tests
    pixi run -e exercises python docs/exercises/ch12_lineage_api.py
"""
...
def run_client_tests():
    ...
    try:
        ...
        print("    pixi run uvicorn docs.exercises.ch12_lineage_api:app --port 8001")
