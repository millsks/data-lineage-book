# Chapter 8: Apache Spark Lineage

[&larr; Back to Index](../index.md) | [Previous: Chapter 7](07-airflow-and-marquez.md)

---

## Chapter Contents

- [8.1 Why Spark Lineage Is Unique](#81-why-spark-lineage-is-unique)
- [8.2 Spark Architecture Refresher](#82-spark-architecture-refresher)
- [8.3 Catalyst Optimizer and Query Plans](#83-catalyst-optimizer-and-query-plans)
- [8.4 OpenLineage Spark Integration](#84-openlineage-spark-integration)
- [8.5 PySpark Lineage in Practice](#85-pyspark-lineage-in-practice)
- [8.6 Reading Query Plans for Lineage](#86-reading-query-plans-for-lineage)
- [8.7 Column-Level Lineage in Spark](#87-column-level-lineage-in-spark)
- [8.8 Spark Streaming Lineage](#88-spark-streaming-lineage)
- [8.9 Common Spark Lineage Patterns](#89-common-spark-lineage-patterns)
- [8.10 Exercise](#810-exercise)
- [8.11 Summary](#811-summary)

---

## 8.1 Why Spark Lineage Is Unique
...
## 8.2 Spark Architecture Refresher
...
## 8.3 Catalyst Optimizer and Query Plans
...
## 8.4 OpenLineage Spark Integration
...
## 8.5 PySpark Lineage in Practice
...
## 8.6 Reading Query Plans for Lineage
...
## 8.7 Column-Level Lineage in Spark
...
## 8.9 Common Spark Lineage Patterns
...
> **Exercise**: Open [`exercises/ch08_spark_lineage.py`](../exercises/ch08_spark_lineage.py)
...
[Chapter 9: dbt Lineage](09-dbt-lineage.md) covers the data transformation tool that puts lineage at the center of its design: `manifest.json`, `ref()` functions, and built-in DAG visualization.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 7](07-airflow-and-marquez.md) | [Next: Chapter 9 &rarr;](09-dbt-lineage.md)
