# Chapter 21: Lineage at Scale

[&larr; Back to Index](../index.md) | [Previous: Chapter 20](20-genai-llm-lineage.md)

---

## Chapter Contents

- [21.1 Scale Challenges](#211-scale-challenges)
- [21.2 Architecture Patterns](#212-architecture-patterns)
- [21.3 Storage Strategies](#213-storage-strategies)
- [21.4 Query Optimization](#214-query-optimization)
- [21.5 Event Ingestion at Scale](#215-event-ingestion-at-scale)
- [21.6 Lineage Versioning and Time Travel](#216-lineage-versioning-and-time-travel)
- [21.7 Multi-Cloud and Hybrid Lineage](#217-multi-cloud-and-hybrid-lineage)
- [21.8 Performance Benchmarking](#218-performance-benchmarking)
- [21.9 Exercise](#219-exercise)
- [21.10 Summary](#2110-summary)

---

## 21.1 Scale Challenges
...
## 21.6 Lineage Versioning and Time Travel
...
## 21.7 Multi-Cloud and Hybrid Lineage
...
> **Exercise**: Open [`exercises/ch21_scale.py`](../exercises/ch21_scale.py)
...
[Chapter 22: Capstone Project](22-capstone-project.md) brings everything together. You will build a complete mini lineage platform with event ingestion, graph storage, a REST API, quality monitoring, governance, and visualization.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 20](20-genai-llm-lineage.md) | [Next: Chapter 22 &rarr;](22-capstone-project.md)
