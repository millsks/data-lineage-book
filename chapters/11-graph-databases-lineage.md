# Chapter 11: Graph Databases for Lineage

[&larr; Back to Index](../index.md) | [Previous: Chapter 10](10-column-level-lineage.md)

---

## Chapter Contents

- [11.1 Why Graph Databases for Lineage?](#111-why-graph-databases-for-lineage)
- [11.2 Graph Database Fundamentals](#112-graph-database-fundamentals)
- [11.3 Neo4j Primer](#113-neo4j-primer)
- [11.4 Modeling Lineage in Neo4j](#114-modeling-lineage-in-neo4j)
- [11.5 Loading Lineage Data into Neo4j](#115-loading-lineage-data-into-neo4j)
- [11.6 Cypher Queries for Lineage](#116-cypher-queries-for-lineage)
- [11.7 Advanced Graph Patterns](#117-advanced-graph-patterns)
- [11.8 Performance and Scaling](#118-performance-and-scaling)
- [11.9 Neo4j vs Alternatives](#119-neo4j-vs-alternatives)
- [11.10 Exercise](#1110-exercise)
- [11.11 Summary](#1111-summary)

---

## 11.1 Why Graph Databases for Lineage?
...
## 11.2 Graph Database Fundamentals
...
## 11.4 Modeling Lineage in Neo4j
...
## 11.5 Loading Lineage Data into Neo4j
...
## 11.6 Cypher Queries for Lineage
...
> **Exercise**: Open [`exercises/ch11_neo4j_lineage.py`](../exercises/ch11_neo4j_lineage.py)
...
[Chapter 12: Building a Lineage API with FastAPI](12-lineage-api-fastapi.md) covers building a REST API over lineage storage so applications and UIs can query lineage programmatically.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 10](10-column-level-lineage.md) | [Next: Chapter 12 &rarr;](12-lineage-api-fastapi.md)
