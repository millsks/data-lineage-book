# Chapter 11: Column-Level Lineage Deep Dive

[&larr; Back to Index](../index.md) | [Previous: Chapter 10](10-dbt-lineage.md)

---

## Chapter Contents

- [11.1 Why Column-Level Lineage?](#111-why-column-level-lineage)
- [11.2 Table-Level vs Column-Level Lineage](#112-table-level-vs-column-level-lineage)
- [11.3 Column Lineage Data Model](#113-column-lineage-data-model)
- [11.4 Transformation Types](#114-transformation-types)
- [11.5 Extracting Column Lineage from SQL](#115-extracting-column-lineage-from-sql)
- [11.6 Column Lineage in OpenLineage](#116-column-lineage-in-openlineage)
- [11.7 Building a Column Lineage Tracker](#117-building-a-column-lineage-tracker)
- [11.8 Visualizing Column Lineage](#118-visualizing-column-lineage)
- [11.9 Use Cases and Applications](#119-use-cases-and-applications)
- [11.10 Exercise](#1110-exercise)
- [11.11 Summary](#1111-summary)

---

## 11.1 Why Column-Level Lineage?
...
## 11.2 Table-Level vs Column-Level Lineage
...
## 11.3 Column Lineage Data Model
...
## 11.5 Extracting Column Lineage from SQL
...
## 11.6 Column Lineage in OpenLineage
...
## 11.7 Building a Column Lineage Tracker
...
## 11.8 Visualizing Column Lineage
...
> **Exercise**: Open [`exercises/ch11_column_lineage.py`](../exercises/ch11_column_lineage.py)
...
In [Chapter 12: Graph Databases for Lineage](12-graph-databases-lineage.md), we'll store this lineage metadata in a graph database (Neo4j) and write Cypher queries for lineage exploration.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 10](10-dbt-lineage.md) | [Next: Chapter 12 &rarr;](12-graph-databases-lineage.md)
