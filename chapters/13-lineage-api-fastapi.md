# Chapter 13: Building a Lineage API with FastAPI

[&larr; Back to Index](../index.md) | [Previous: Chapter 12](12-graph-databases-lineage.md)

---

## Chapter Contents

- [13.1 Why Build a Lineage API?](#131-why-build-a-lineage-api)
- [13.2 API Design Principles](#132-api-design-principles)
- [13.3 Pydantic Models for Lineage](#133-pydantic-models-for-lineage)
- [13.4 Building the FastAPI Application](#134-building-the-fastapi-application)
- [13.5 Lineage Endpoints](#135-lineage-endpoints)
- [13.6 Impact Analysis Endpoint](#136-impact-analysis-endpoint)
- [13.7 Search and Discovery](#137-search-and-discovery)
- [13.8 OpenLineage Event Ingestion](#138-openlineage-event-ingestion)
- [13.9 Testing the API](#139-testing-the-api)
- [13.10 Exercise](#1310-exercise)
- [13.11 Summary](#1311-summary)

---

## 13.1 Why Build a Lineage API?

A lineage API decouples lineage **producers** (Kedro, Airflow, Spark, dbt) from **consumers** (UIs, CLIs, auditors, AI assistants).
...
## 13.3 Pydantic Models for Lineage
...
## 13.4 Building the FastAPI Application
...
## 13.8 OpenLineage Event Ingestion
...
> **Exercise**: Open [`exercises/ch13_lineage_api.py`](../exercises/ch13_lineage_api.py)
...
In [Chapter 14: Data Quality and Lineage](14-data-quality-lineage.md), we begin Part IV (Production Patterns) by exploring how data quality integrates with lineage. You will use tools like Great Expectations to add quality metadata to your lineage graph.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 12](12-graph-databases-lineage.md) | [Next: Chapter 14 &rarr;](14-data-quality-lineage.md)
