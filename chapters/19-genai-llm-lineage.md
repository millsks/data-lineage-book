# Chapter 19: GenAI & LLM Lineage

[&larr; Back to Index](../index.md) | [Previous: Chapter 18](18-ml-lineage.md)

---

## Chapter Contents

- [19.1 Why GenAI Needs Lineage](#191-why-genai-needs-lineage)
- [19.2 The GenAI Data Pipeline](#192-the-genai-data-pipeline)
- [19.3 RAG Lineage: Retrieval-Augmented Generation](#193-rag-lineage-retrieval-augmented-generation)
- [19.4 Prompt Chain Lineage](#194-prompt-chain-lineage)
- [19.5 Embedding and Vector Store Lineage](#195-embedding-and-vector-store-lineage)
- [19.6 Fine-Tuning Lineage](#196-fine-tuning-lineage)
- [19.7 LLM Observability and Lineage](#197-llm-observability-and-lineage)
- [19.8 Governance for GenAI Outputs](#198-governance-for-genai-outputs)
- [19.9 Exercise](#199-exercise)
- [19.10 Summary](#1910-summary)

---

## 19.1 Why GenAI Needs Lineage
...
## 19.3 RAG Lineage: Retrieval-Augmented Generation
...
## 19.5 Embedding and Vector Store Lineage
...
## 19.7 LLM Observability and Lineage
...
## 19.8 Governance for GenAI Outputs
...
> **Exercise**: Open [`exercises/ch19_genai_lineage.py`](../exercises/ch19_genai_lineage.py)
...
[Chapter 20: Lineage at Scale](20-lineage-at-scale.md) addresses the engineering challenges of running lineage in production: event-driven architecture, tiered storage, query optimization, temporal versioning, and multi-cloud federation.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 18](18-ml-lineage.md) | [Next: Chapter 20 &rarr;](20-lineage-at-scale.md)
