# Chapter 21: Capstone Project — Building a Complete Lineage Platform

[&larr; Back to Index](../index.md) | [Previous: Chapter 20](20-lineage-at-scale.md)

---

## Chapter Contents

- [21.1 Project Overview](#211-project-overview)
- [21.2 Architecture Design](#212-architecture-design)
- [21.3 Phase 1: Data Model and Storage](#213-phase-1-data-model-and-storage)
- [21.4 Phase 2: Event Ingestion](#214-phase-2-event-ingestion)
- [21.5 Phase 3: Graph Queries and API](#215-phase-3-graph-queries-and-api)
- [21.6 Phase 4: Quality and Observability](#216-phase-4-quality-and-observability)
- [21.7 Phase 5: Governance and Classification](#217-phase-5-governance-and-classification)
- [21.8 Phase 6: Visualization](#218-phase-6-visualization)
- [21.9 Testing Strategy](#219-testing-strategy)
- [21.10 Putting It All Together](#2110-putting-it-all-together)
- [21.11 Summary and Next Steps](#2111-summary-and-next-steps)
...
> `exercises/ch21_capstone/` package.
...
## 21.3 Phase 1: Data Model and Storage
...
## 21.5 Phase 3: Graph Queries and API
...
## 21.6 Phase 4: Quality and Observability
...
## 21.7 Phase 5: Governance and Classification
...
pixi run uvicorn exercises.ch21_capstone.api:app --reload --port 8000

# Terminal 2: Seed data
pixi run python exercises/ch21_capstone/seed_data.py
