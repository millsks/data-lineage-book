# Chapter 10: dbt Lineage

[&larr; Back to Index](../index.md) | [Previous: Chapter 9](09-spark-lineage.md)

---

## Chapter Contents

- [10.1 dbt and the Analytics Engineering Paradigm](#101-dbt-and-the-analytics-engineering-paradigm)
- [10.2 How dbt Models Lineage](#102-how-dbt-models-track-lineage)
- [10.3 The ref() and source() Functions](#103-the-ref-and-source-functions)
- [10.4 The manifest.json: dbt's Lineage Artifact](#104-the-manifestjson-dbts-lineage-artifact)
- [10.5 Parsing manifest.json for Lineage](#105-parsing-manifestjson-for-lineage)
- [10.6 The catalog.json: Schema Metadata](#106-the-catalogjson-schema-metadata)
- [10.7 dbt Exposures: Downstream Consumers](#107-dbt-exposures-downstream-consumers)
- [10.8 Visualizing dbt Lineage](#108-visualizing-dbt-lineage)
- [10.9 dbt + OpenLineage Integration](#109-dbt--openlineage-integration)
- [10.10 Exercise](#1010-exercise)
- [10.11 Summary](#1011-summary)

---

## 10.1 dbt and the Analytics Engineering Paradigm
...
## 10.2 How dbt Models Track Lineage
...
graph TD
    ...
    style S1 fill:#1009399,color:#fff
    style S2 fill:#1009399,color:#fff
    style S3 fill:#1009399,color:#fff
...
## 10.3 The ref() and source() Functions
...
## 10.4 The manifest.json: dbt's Lineage Artifact
...
## 10.5 Parsing manifest.json for Lineage
...
## 10.6 The catalog.json: Schema Metadata
...
## 10.7 dbt Exposures: Downstream Consumers
...
## 10.9 dbt + OpenLineage Integration
...
> **Exercise**: Open [`exercises/ch10_dbt_lineage.py`](../exercises/ch10_dbt_lineage.py)
...
- **OpenLineage integration** connects dbt lineage to the broader ecosystem (Marquez, Kedro, Spark, Airflow)
...
[Chapter 11: Column-Level Lineage Deep Dive](11-column-level-lineage.md) moves from table-level to column-level lineage, tracking how individual fields move through pipelines.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 9](09-spark-lineage.md) | [Next: Chapter 11 &rarr;](11-column-level-lineage.md)
