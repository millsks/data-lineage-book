# Chapter 7: Apache Airflow & Marquez
...
- [7.1 Why Orchestration Lineage Matters](#71-why-orchestration-lineage-matters)
- [7.2 Apache Airflow Primer](#72-apache-airflow-primer)
- [7.3 Lineage in Airflow: The OpenLineage Integration](#73-lineage-in-airflow-the-openlineage-integration)
- [7.4 Introducing Marquez](#74-introducing-marquez)
- [7.5 Setting Up Airflow with OpenLineage](#75-setting-up-airflow-with-openlineage)
- [7.6 How Airflow Emits Lineage Events](#76-how-airflow-emits-lineage-events)
- [7.7 Exploring Lineage in the Marquez UI](#77-exploring-lineage-in-the-marquez-ui)
- [7.8 Querying the Marquez API](#78-querying-the-marquez-api)
- [7.9 Custom Extractors](#79-custom-extractors)
- [7.10 Exercise](#710-exercise)
- [7.11 Summary](#711-summary)

---

## 7.1 Why Orchestration Lineage Matters
...
## 7.3 Lineage in Airflow: The OpenLineage Integration
...
## 7.5 Setting Up Airflow with OpenLineage
...
## 7.6 How Airflow Emits Lineage Events
...
## 7.7 Exploring Lineage in the Marquez UI
...
> **Exercise**: Open [`exercises/ch07_airflow_marquez.py`](../exercises/ch07_airflow_marquez.py)
...
In [Chapter 8: Apache Spark Lineage](08-spark-lineage.md), we'll explore how Spark captures lineage from its query execution plans.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 6](06-sql-lineage-parsing.md) | [Next: Chapter 8 &rarr;](08-spark-lineage.md)
