# Chapter 15: Streaming & Real-Time Lineage

[&larr; Back to Index](../index.md) | [Previous: Chapter 14](14-data-observability.md)

---

## Chapter Contents

- [15.1 Batch vs Streaming Lineage](#151-batch-vs-streaming-lineage)
- [15.2 Kafka and Event-Driven Architectures](#152-kafka-and-event-driven-architectures)
- [15.3 Tracking Lineage Through Topics and Consumers](#153-tracking-lineage-through-topics-and-consumers)
- [15.4 Stream Processing Lineage (Flink & Spark Streaming)](#154-stream-processing-lineage-flink--spark-streaming)
- [15.5 Change Data Capture (CDC) Lineage](#155-change-data-capture-cdc-lineage)
- [15.6 Real-Time Lineage Event Architecture](#156-real-time-lineage-event-architecture)
- [15.7 Building a Kafka Lineage Tracker](#157-building-a-kafka-lineage-tracker)
- [15.8 Exercise](#158-exercise)
- [15.9 Summary](#159-summary)

---

## 15.1 Batch vs Streaming Lineage
...
## 15.2 Kafka and Event-Driven Architectures
...
## 15.3 Tracking Lineage Through Topics and Consumers
...
## 15.4 Stream Processing Lineage (Flink & Spark Streaming)
...
## 15.5 Change Data Capture (CDC) Lineage
...
## 15.6 Real-Time Lineage Event Architecture
...
## 15.7 Building a Kafka Lineage Tracker
...
> **Exercise**: Open [`exercises/ch15_streaming_lineage.py`](../exercises/ch15_streaming_lineage.py)
...
[Chapter 16: Compliance, Governance & Privacy](16-compliance-governance-privacy.md) turns to the regulatory side, showing how lineage supports GDPR, CCPA, SOX, and HIPAA through PII tracking, audit trails, and automated erasure plans.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 14](14-data-observability.md) | [Next: Chapter 16 &rarr;](16-compliance-governance-privacy.md)
