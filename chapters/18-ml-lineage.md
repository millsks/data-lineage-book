# Chapter 18: ML & MLOps Lineage

[&larr; Back to Index](../index.md) | [Previous: Chapter 17](17-data-mesh-federated-lineage.md)

---

## Chapter Contents

- [18.1 Why ML Needs Lineage](#181-why-ml-needs-lineage)
- [18.2 The ML Lifecycle](#182-the-ml-lifecycle)
- [18.3 Feature Lineage](#183-feature-lineage)
- [18.4 Experiment Tracking with MLflow](#184-experiment-tracking-with-mlflow)
- [18.5 Model Lineage: Training Data to Predictions](#185-model-lineage-training-data-to-predictions)
- [18.6 Feature Store Lineage](#186-feature-store-lineage)
- [18.7 Model Registry and Deployment Lineage](#187-model-registry-and-deployment-lineage)
- [18.8 Connecting ML Lineage to Data Lineage](#188-connecting-ml-lineage-to-data-lineage)
- [18.9 Exercise](#189-exercise)
- [18.10 Summary](#1810-summary)

---

## 18.1 Why ML Needs Lineage
...
## 18.4 Experiment Tracking with MLflow
...
## 18.5 Model Lineage: Training Data to Predictions
...
## 18.7 Model Registry and Deployment Lineage
...
## 18.8 Connecting ML Lineage to Data Lineage
...
> **Exercise**: Open [`exercises/ch18_ml_lineage.py`](../exercises/ch18_ml_lineage.py)
...
[Chapter 19: GenAI & LLM Lineage](19-genai-llm-lineage.md) takes lineage into generative AI, covering RAG pipelines, prompt chains, embedding provenance, and governance for LLM-powered applications.

---

[&larr; Back to Index](../index.md) | [Previous: Chapter 17](17-data-mesh-federated-lineage.md) | [Next: Chapter 19 &rarr;](19-genai-llm-lineage.md)
